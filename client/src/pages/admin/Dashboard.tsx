  ...
  const setTestTimeMutation = trpc.admin.setTestTime.useMutation({
    onSuccess: async () => {
      ...
      await Promise.all([
        refetchStats(),
        refetchTestTime(),
        utils.qr.getActive.invalidate(),
        utils.qr.getCurrentCode.invalidate(),
        utils.qr.getScanInfo.invalidate(),
        utils.qr.forceGenerateCode.invalidate(),
        utils.qr.generate.invalidate(),
        ...
        utils.attendance.listAll.invalidate(),
        utils.schedule.getCurrentWeek.invalidate(),
        utils.schedule.list.invalidate(),
        utils.swap.getRequestOptions.invalidate(),
        utils.swap.getMyRequests.invalidate(),
        utils.swap.getPending.invalidate(),
